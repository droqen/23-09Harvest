        ...
        for character_url in chars {
            ...
            entity::add_components(
                ...
                make_transformable()
                    ...
                    .with(
                        packages::basic_character_animation::components::idle(),
                        anim_url("Zombie Idle"),
                    )
                    .with(
                        packages::basic_character_animation::components::walk_forward(),
                        anim_url("Zombie Walk"),
                    )
                    .with(
                        packages::basic_character_animation::components::run_forward(),
                        anim_url("Zombie Run"),
                    )
                    .with(
                        packages::basic_character_animation::components::death(),
